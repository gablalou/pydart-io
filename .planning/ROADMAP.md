...
- [x] 03-02-PLAN.md — Compression codecs (snappy/zstd/gzip/uncompressed, honest rejection) + row-count row-group sizing (PARQ-02, PARQ-03)

**Wave 3** *(blocked on Waves 1-2)*

- [x] 03-03-PLAN.md — Predicate pushdown (row-group skip + exact row filter) + column projection (PARQ-04, PARQ-05)

**Wave 4** *(blocked on Waves 1-3)*

- [x] 03-04-PLAN.md — Logical-type fidelity (tz + categorical/dictionary), WR-01/D-31 nullability fix, multi-file/directory read (PARQ-06, PARQ-01)
...
| 4. Benchmark & Release Readiness | 1/4 | In Progress|  |
