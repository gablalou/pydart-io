//! CAP-02: `pydart.from_arrow` — import a foreign Arrow PyCapsule-compliant object into a `Table`.
//!
...
//! whatever `PyErr` pyo3-arrow's import produced onto `pydart.PydartError` (this project's own
...
/// pydart `Table`, zero-copy, via the Arrow PyCapsule Interface (CAP-02).
///
...
/// leaving no place to catch a validation failure and remap it onto `pydart.PydartError`. Calling
